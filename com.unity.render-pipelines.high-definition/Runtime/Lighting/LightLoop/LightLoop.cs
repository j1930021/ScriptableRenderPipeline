                ...
                if (cullResults.visibleLights.Count != 0 || cullResults.visibleReflectionProbes.Count != 0)
                {
                    ...
                    for (int sortIndex = 0; sortIndex < sortCount; ++sortIndex)
                    {
                        ...
                        if (additionalLightData.WillRenderShadows())
                        {
                            ...
                            shadowIndex = additionalLightData.UpdateShadowRequest(camera, m_ShadowManager, light, cullResults, lightIndex, out shadowRequestCount);
                    ...
                    // Update the comnpute buffer with the shadow request datas
